...
exec qemu-system-x86_64 -enable-kvm -cpu host -smp 2 -m 2G \
  ...
  -append "root=/dev/vda1 rw rootwait console=ttyS0,115200 earlycon=ttyS0,115200 kgdb.use_kdb=0 kgdboc=ttyS1,115200 nokaslr pcie_ports=native usbcore.quirks=46f4:0002:u" \
